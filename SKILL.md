...
## Common Issues
- Game tak load â†’ pastikan dynamic import dengan `ssr: false`
- Phaser canvas overflow â†’ guna `Phaser.Scale.FIT` + `w-full h-full` pada container
- PM2 crash â†’ `pm2 logs gameportal` untuk check error
